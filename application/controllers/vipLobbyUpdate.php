...
class vipLobbyUpdate extends APN_Controller {
	...
	public function index(){
            ...
            $this->_set('title', "VIP Lobby Update | P: 949-221-0010 | Assured Performance Network");
...
//            test javascript and css files
            ...
            $this->load->view('basic/content/vipLobbyUpdate');
